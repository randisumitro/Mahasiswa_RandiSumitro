package com.example.mahasiswa_aulyafani.db;
...
import com.example.mahasiswa_aulyafani.model.Mahasiswa; // ✅ perbaikan package
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_STD); // ✅ hapus tanda kutip berlebih
        onCreate(db);
    }
    ...
    public ArrayList<Mahasiswa> getAllUsers() {
        ...
        c.close(); // ✅ jangan lupa close cursor
